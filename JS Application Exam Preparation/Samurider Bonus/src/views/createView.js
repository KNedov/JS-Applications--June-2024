...
async function onCreate({model,imageUrl,year,mileage,contact,about}) {
    ...
    if (!model||!imageUrl||!year||!mileage||!contact||!about)return window.alert('All fields are required')
    await dataService.create({model,imageUrl,year,mileage,contact,about})
