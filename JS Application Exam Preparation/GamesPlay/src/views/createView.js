...
async function onCreate({title,category,maxLevel,imageUrl,summary}) {
    ...
    if (!title||!category||!maxLevel||!imageUrl||!summary)return window.alert('All fields are required')
    await dataService.create({title,category,maxLevel,imageUrl,summary})
